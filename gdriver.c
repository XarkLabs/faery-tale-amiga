...
// TODO: playsample - play audio sample
void playsample(UBYTE * ptr, LONG length, LONG rate)
{
    (void)ptr;
    (void)length;
    (void)rate;
    RUNLOGF("<= playsample(%p, %d, %d) STUB", ptr, length, rate);
}
...
// TODO: setscore - set music score track beginnings
void setscore(UBYTE * t1, UBYTE * t2, UBYTE * t3, UBYTE * t4)
{
    ...
    (void)t3;
    (void)t4;
    RUNLOGF("<= setscore(%p, %p, %p, %p) STUB", t1, t2, t3, t4);
}
...
// TODO - playscore - play music score
void playscore(UBYTE * t1, UBYTE * t2, UBYTE * t3, UBYTE * t4)
{
    ...
    (void)t3;
    (void)t4;
    RUNLOGF("<= playscore(%p, %p, %p, %p) STUB", t1, t2, t3, t4);
}
...
void init_music(SHORT * new_wave, UBYTE * wav_mem, UBYTE * vol_mem)
{
    ...
    (void)wav_mem;
    (void)vol_mem;
    RUNLOGF("<= init_music(%p, %p, %p) STUB", new_wave, wav_mem, vol_mem);
}
...
// TODO: wrap_music - stop music, remove interrupt restore vector
void wrap_music(void)
{
    RUNLOG("<= wrap_music() STUB");
}
